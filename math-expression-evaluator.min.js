!(function (e, t) {
        ...
        for (E = 0; E < w.length; E++) {
            ...
            if (14 !== P.type) {
                ...
                if (g === t.FUNCTION_WITH_ONE_ARG) (O = o), (R = u), a(c, 1), A.push(U), w[E + 1].type !== t.OPENING_PARENTHESIS && (A.push(y), c.push(2));
                    ...
                    S.type !== t.NUMBER && ((S = { show: "0", value: 0, type: t.NUMBER, precedence: 0 }), A.push(S)), (O = p), a(c, 1), (R = u), (S.value += C), (S.hasDec = !0);
    ...
    function y(e, t) {
        ...
        for (var n, a, o, h = [], r = void 0 !== t.n, u = 0; u < e.length; u++)
            if (1 === e[u].type) h.push({ value: e[u].value, type: 1 });
            else if (3 === e[u].type) h.push({ value: t[e[u].value], type: 1 });
            else if (0 === e[u].type) {
                var s = h[h.length - 1];
                ...
                h.push({ type: 1, value: e[u].value.apply(e[u], i.reverse()) });
            } else if (10 === e[u].type)
                (n = h.pop()), (a = h.pop()), Array.isArray(a) ? ((a = a.concat(n)).push(e[u]), h.push(a)) : Array.isArray(n) ? (n.unshift(a), n.push(e[u]), h.push(n)) : h.push({ type: 1, value: e[u].value(a.value, n.value) });
            ...
            } else 13 === e[u].type && (r ? h.push({ value: t[e[u].value], type: 3 }) : h.push([e[u]]));
            ...
            (this.toPostfix = f),
                ...
                (this.math =
                    ((t = this),
                    {
                        ...
                        div: function (e, t) {
                            if (t == 0) throw new Error("infinity")
                            if (Math.abs(t) > 1e9) throw new Error("explode");
                            if (Math.abs(t) < 1e-9) throw new Error("explode");
                            return e / t;
                        },
                        fact: function (e) {
                            if (e % 1 != 0) throw new Error("undefined");
                            if (e < 0) throw new Error("undefined");
                            if (e > 20) throw new Error("explode");
                        ...
                        Pi: function (e, n, a) {
                            for (var o = 1, h = e; h <= n; h++) o *= Number(t.postfixEval(a, { n: h }));
                            return o;
                        },
                        pow: function(x, y) {
                            if (Math.abs(y) > 20) throw new Error("explode");
                            if (Math.abs(Math.pow(x,y)) < 1e-9 && x != 0) throw new Error("explode");
                            if (Math.abs(Math.pow(x,y)) > 1e15) throw new Error("explode");
                            return Math.pow(x,y);
                        },
                        pow10x: function (e) {
                            for (var t = 1; e--; ) t *= 10;
                        ...
                        sigma: function (e, n, a) {
                            for (var o = 0, h = e; h <= n; h++) o += Number(t.postfixEval(a, { n: h }));
                            return o;
                        },
                        sin: function (e) {
